...
class ticketissue extends StatefulWidget {
  const ticketissue({super.key});

  @override
  State<ticketissue> createState() => _ticketissueState();
}

class _ticketissueState extends State<ticketissue> {
  ...
  void initState() {
    super.initState();
    databaseReference_3 = FirebaseDatabase.instance.ref().child('TicketIssue');
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Issue Ticket')),
      body: Padding(
